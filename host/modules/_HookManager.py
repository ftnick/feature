...
if __name__ == "__main__":
    ...
    error = "F0001"
    message = (
        "Warning: This program is not intended to be run directly. "
        f"For more details, please visit: https://feature.ftnick.xyz/debug?error={error}&file={script_name}"
    )
